define("echarts/chart/map", ["require", "./base", "zrender/shape/Text", "zrender/shape/Path", "zrender/shape/Circle", "zrender/shape/Rectangle", "zrender/shape/Line", "zrender/shape/Polygon", "zrender/shape/Ellipse", "../component/dataRange", "../component/roamController", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/event", "../util/mapData/params", "../util/mapData/textFixed", "../util/mapData/geoCoord", "../util/projection/svg", "../util/projection/normal", "../chart"], function (e) {
    ...
    var i = e("./base"), n = e("zrender/shape/Text"), a = e("zrender/shape/Path"), o = e("zrender/shape/Circle"), r = e("zrender/shape/Rectangle"), s = e("zrender/shape/Line"), l = e("zrender/shape/Polygon"), h = e("zrender/shape/Ellipse");
    ...
    var V = e("../util/ecData"), U = e("zrender/tool/util"), d = e("zrender/config"), p = e("zrender/tool/event"), c = e("../util/mapData/params").params, u = e("../util/mapData/textFixed"), y = e("../util/mapData/geoCoord");
    return t.prototype = {
        type: m.CHART_TYPE_MAP, _buildShape: function () {
            var e = this.series;
            ...
            if ("china" == e) {
                var p = this.geo2pos(e, y["南海诸岛"] || c["南海诸岛"].textCoord), g = n.scale.x / 10.5, b = [32 * g + p[0], 83 * g + p[1]];
                u["南海诸岛"] && (b[0] += u["南海诸岛"][0], b[1] += u["南海诸岛"][1]), o.push({
            ...
            var n, a = t.properties.name, o = u[a] || [0, 0];
            if (y[a])n = this.geo2pos(e, y[a]); else if (t.cp)n = [t.cp[0] + o[0], t.cp[1] + o[1]]; else {
            ...
            for (var p, c, u, y, g, b, f, k, x, _, L, W = this.series, X = this.component.legend, K = this.component.dataRange, v = 0, w = t.length; w > v; v++) {
                if (k = U.clone(t[v]), x = {
                    ...
                    g = [u], p = "";
                    for (var I = 0, J = u.seriesIndex.length; J > I; I++)g.push(W[u.seriesIndex[I]]), p += W[u.seriesIndex[I]].name + " ", X && this._showLegendSymbol[e] && X.hasColor(W[u.seriesIndex[I]].name) && this.shapeList.push(new o({
                ...
                switch (this.ecTheme.map && g.push(this.ecTheme.map), g.push(m.map), b = K && !isNaN(y) ? K.getColor(y) : null, k.color = k.color || b || this.getItemStyleColor(this.deepQuery(g, "itemStyle.normal.color"), u.seriesIndex, -1, u) || this.deepQuery(g, "itemStyle.normal.areaStyle.color"), k.strokeColor = k.strokeColor || this.deepQuery(g, "itemStyle.normal.borderColor"), k.lineWidth = k.lineWidth || this.deepQuery(g, "itemStyle.normal.borderWidth"), x.color = this.getItemStyleColor(this.deepQuery(g, "itemStyle.emphasis.color"), u.seriesIndex, -1, u) || this.deepQuery(g, "itemStyle.emphasis.areaStyle.color") || k.color, x.strokeColor = this.deepQuery(g, "itemStyle.emphasis.borderColor") || k.strokeColor, x.lineWidth = this.deepQuery(g, "itemStyle.emphasis.borderWidth") || k.lineWidth, k.brushType = x.brushType = k.brushType || "both", k.lineJoin = x.lineJoin = "round", k._name = x._name = c, f = this.deepQuery(g, "itemStyle.normal.label.textStyle"), L = {
                    ...
                    _style: U.clone(k),
                    _mapType: e
                }, null != k.scale && (_.scale = U.clone(k.scale)), L = new n(L), _.style.shapeType) {
                    case"rectangle":
                        _ = new r(_);
                        break;
                    case"line":
            ...
            if (!(this.shapeList.length <= 0)) {
                ...
                var r, s, l = e.event, h = p.getX(l), V = p.getY(l), U = p.getDelta(l), d = e.mapTypeControl;
                d || (d = {}, s = this._findMapTypeByPos(h, V), s && this._roamMap[s] && "move" != this._roamMap[s] && (d[s] = !0));
                var c = !1;
                for (s in d)if (d[s]) {
                    c = !0;
                    var u = this._mapDataMap[s].transform, y = u.left, g = u.top, b = u.width, f = u.height, k = this.pos2geo(s, [h - y, V - g]);
                    if (U > 0) {
                ...
                if (c) {
                    ...
                    }, 100), this.messageCenter.dispatch(m.EVENT.MAP_ROAM, e.event, {type: "scale"}, this.myChart)
                }
            }
            ...
            if (!(this.shapeList.length <= 0)) {
                var t = e.target;
                if (!t || !t.draggable) {
                    var i = e.event, n = p.getX(i), a = p.getY(i), o = this._findMapTypeByPos(n, a);
            ...
            if (this._mousedown && this._isAlive) {
                var t = e.event, i = p.getX(t), n = p.getY(t), a = this._mapDataMap[this._curMapType].transform;
            ...
            var i = this;
            setTimeout(function () {
                i._justMove && i.animationEffect(), i._justMove = !1, i.zr.un(d.EVENT.MOUSEMOVE, i._onmousemove), i.zr.un(d.EVENT.MOUSEUP, i._onmouseup)
            }, 120)
            ...
            for (var t, i, n = 0, a = this.shapeList.length; a > n; n++)t = this.shapeList[n]._mapType, this._hoverLinkMap[t] && this._activeMapType[t] && (i = V.get(this.shapeList[n], "value"), null != i && i >= e.valueMin && i <= e.valueMax && this.zr.addHoverShape(this.shapeList[n]))
        }, onclick: function (e) {
            ...
            this._isAlive = !1, this.zr.un(d.EVENT.MOUSEWHEEL, this._onmousewheel), this.zr.un(d.EVENT.MOUSEDOWN, this._onmousedown), this.messageCenter.unbind(m.EVENT.ROAMCONTROLLER, this._onroamcontroller), this.messageCenter.unbind(m.EVENT.DATA_RANGE_HOVERLINK, this._ondrhoverlink)
        }
    ...
    return s.prototype = {
        type: "path", buildPathArray: function (e, t, i) {
            ...
            a === s && (c *= -1), isNaN(c) && (c = 0);
            var u = c * l * d / h, y = c * -h * U / l, g = (e + i) / 2 + Math.cos(V) * u - Math.sin(V) * y, b = (t + n) / 2 + Math.sin(V) * u + Math.cos(V) * y, f = r([1, 0], [(U - u) / l, (d - y) / h]), k = [(U - u) / l, (d - y) / h], x = [(-1 * U - u) / l, (-1 * d - y) / h], _ = r(k, x);
            ...
            for (var l = 0, h = o.length; h > l; l++) {
                ...
                switch (d) {
                    ...
                    case"Q":
                        ...
                        break;
                    case"A":
                        var p = m[0], c = m[1], u = m[2], y = m[3], g = m[4], b = m[5], f = m[6], k = m[7], x = u > y ? u : y, _ = u > y ? 1 : u / y, L = u > y ? y / u : 1;
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATARANGE, _textGap: 10, _buildShape: function () {
            ...
            this._fillerShape = {
                ...
                z: this.getZBase() + 1,
                style: {
                    x: this._calculableLocation.x, y: this._calculableLocation.y, width: this._calculableLocation.width,
                    height: this._calculableLocation.height, color: "rgba(255,255,255,0)"
                },
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "4413", properties: {name: "惠州市", cp: [114.6204, 23.1647], childNum: 4}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "469026", properties: {name: "屯昌县", cp: [110.0377, 19.362], childNum: 1}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            id: "4210",
            properties: {
                name: "荆州市", cp: [113.291, 30.0092], childNum: 7
            },
            geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "310114", properties: {name: "嘉定区", cp: [121.2437, 31.3625], childNum: 1}, geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature", id: "5105", properties: {name: "泸州市", cp: [105.4578, 28.493], childNum: 5}, geometry: {
                type: "Polygon",
